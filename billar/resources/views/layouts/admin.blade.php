<!DOCTYPE html>
      <html>
        <head>
          ...
          <!-- Bootstrap 3.3.5 -->
          <link rel="stylesheet" href="/sisVentas/public/css/bootstrap.min.css">
          <!-- Font Awesome -->
          <link rel="stylesheet" href="/sisVentas/public/css/font-awesome.css">
          <!-- Theme style -->
        ...
        <body class="hold-transition skin-blue sidebar-mini">
                          ...
                          <div class="pull-right">
                            <a href="{{ route('logout') }}" 
                                             onclick="event.preventDefault();
                                                           document.getElementById('logout-form').submit();" class="btn btn-default btn-flat">Cerrar
                            </a>
                ...
                <ul class="sidebar-menu">
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li><a href="{{ route('category.index')}}"><i class="fa fa-circle-o"></i> Categorías</a></li>
                    </ul>
                  </li>
          ...
          <!-- Bootstrap 3.3.5 -->
          <script src="/sisVentas/public/js/bootstrap.min.js"></script>
          <!-- AdminLTE App -->
          <script src="/sisVentas/public/js/app.min.js"></script>
